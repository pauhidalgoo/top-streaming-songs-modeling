...
#VECTORES NUMERICOS Y CATEGORICOS
 numeric_cols <- list(   list("track_popularity","76.0","50.0"),
   list("album_popularity","72.0","25.0"),
   list("artist_followers","60000000.0","30000000.0"),
   list("artist_popularity","90.0","80.0"),
   ...
   list("tempo","140.0","90.0"),
   list("duration","220.0","180.0"),
...
categoric_cols <- list(   list("album_type",c("single"),c("album")),
   ...
   list("rank_group",c("1-10"),c("30-40")),
   list("gender",c("male"),c("female")),
