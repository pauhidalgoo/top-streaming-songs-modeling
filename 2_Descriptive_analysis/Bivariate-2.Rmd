---
title: "Anàlisi Descriptiu Bivariant Preprocessat"
output:
...
Per fer el anàlisi bivariant després del preprocessament, s'han analitzat parells de diferents tipus de variables per observar si hi ha relacions entre variables:


```{r, echo=FALSE}
numeric_cols <- c("track_popularity","album_popularity","artist_popularity", "artist_followers", "artist_num","energy","loudness","speechiness","acousticness", "danceability", "liveness", "valence", "tempo", "duration", "streams")
categoric_cols <- c("album_type","pop","hip_hop", "electro", "rock","christmas","cinema","latino","collab","explicit","key","major_mode","time_signature","is_group","gender","rank_group", "nationality")
