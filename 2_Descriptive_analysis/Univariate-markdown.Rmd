---
title: "Univariate descriptive analysis preprocessed"
output:
  html_document:
    df_print: paged
...
load("C:/Users/barre/Documents/UPC/GIA/Q3/MEstadistica/spotify/data.Rdata")
...
#Exception for the lyrics variable, as writing the entire lyrics for each graphic and statistics shown would take up much screen space
lyrics_short<-as.data.frame(data[,46])

for (i in 1:nrow(lyrics_short)){
  lyrics_short[i,1] <- str_trunc(lyrics_short[i,1],30)
}
univariate(lyrics_short, "lyrics")
